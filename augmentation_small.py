...
def random_augmentator(img, x_min, y_min, x_max, y_max):
    ...
    image_aug, new_xmin, new_ymin, new_xmax, new_ymax = pick_contras(x, img, x_min, y_min, x_max, y_max)
...
if __name__ == "__main__":
    ...
    # path.append('Images\GTSDB\RGB_300x300_Crop_Multi')
    csv_file = 'GTSDB.csv'
    folder = 'augmented'
    total = 600
    ...
    # augmentation(single, csv_file, folder, total)
    # augmentation(multi, csv_file, folder, total)
    augmentationSomeClass(some, csv_file, folder, total)
